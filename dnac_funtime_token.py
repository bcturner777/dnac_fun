...
from dnac_config import DNAC_IP, DNAC_PORT, DNAC_USERNAME, DNAC_PASSWORD
...
def get_auth_token():
    ...
    resp = requests.post(url, auth=HTTPBasicAuth(DNAC_USERNAME, DNAC_PASSWORD))  # Make the POST Request
